...
export const HOME: HomeContent = {
  hero: {
    ...
    chips: [
      { id: 'licensed', label: 'TDLR-licensed provider', icon: 'shield-check' },
      { id: 'live', label: 'Live instructor on Zoom', icon: 'video' },
      { id: 'certificate', label: 'Certificate on completion', icon: 'award' },
    ],
